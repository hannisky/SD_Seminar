table 50110 "CSD Seminar Reg. Header"
{
    ...
    fields
    {
        ...
        field(3; "Seminar No."; Code[20])
        {
            ...
            begin
                if "Seminar No." <> xRec."Seminar No." then begin
                    ...
                    "Minimum Partypants" := Seminar."Minimum Partypants";
                    "Maximum Partypants" := Seminar."Maximum Partypants";
                end;
            end;
        }
        ...
        field(9; "Maximum Partypants"; Integer)
        {
            Caption = 'Maximum Partypants';
            DataClassification = AccountData;
        }
        field(10; "Minimum Partypants"; Integer)
        {
            ...
            begin
                if "Room Resource No." = '' then begin
                    ...
                    if (CurrFieldNo <> 0) then begin
                        if (SeminarRoom."CSD Maximum Partypants" <> 0) and
                           (SeminarRoom."CSD Maximum Partypants" < "Maximum Partypants")
                        then begin
                            if Confirm(Text004, true,
                                 "Maximum Partypants",
                                 SeminarRoom."CSD Maximum Partypants",
                                 FieldCaption("Maximum Partypants"),
                                 "Maximum Partypants",
                                 SeminarRoom."CSD Maximum Partypants")
                            then
                                "Maximum Partypants" := SeminarRoom."CSD Maximum Partypants";
                        end;
                    end;
                end;
            end;
